...
import com.hw.hardware.common.exception.OwnHttpException;
...
public class HttpClient {
	...
	private List<Entry<String,Object>> params = Lists.newArrayList();
	...
	public String execute() throws Exception{
		...
		if (rescode != HttpStatus.SC_OK) {
			throw new OwnHttpException(rescode,method.getResponseBodyAsString());
		}
	...
	private Part[] getPartList() throws Exception{
		List<Part> data = Lists.newArrayList();
